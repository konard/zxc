// Source: https://doc.rust-lang.org/stable/nightly-rustc/src/rustc_index/bit_set.rs.html
...
// #[derive(Hash)] -- fixme: smallvec is not `Hash`
...
impl fmt::Debug for FiniteBitSet<u128> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
